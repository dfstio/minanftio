    ...
    <div className="gx-layout-sider-header">
      ...
      <Link to="/" className="gx-site-logo">
        {navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR && width >= TAB_SIZE ? (
          <img alt="lo" src={"/assets/images/minanft.png"} />
        ) : themeType === THEME_TYPE_LITE ? (
          <img alt="logo1" src={"/assets/images/minanft.png"} />
        ) : (
          <img alt="logo2" src={"/assets/images/minanft.png"} />
        )}
        <text style={{ "font-size": "22px", "padding-left": "10px" }}>
          Mina NFT
        </text>
      </Link>
    </div>

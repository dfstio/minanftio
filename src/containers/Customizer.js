        ...
        return (
            <ul className="gx-layout-option gx-list-inline">
                <li>
                    ...
                    >
                        <img
                            src={"/assets/images/layouts/framed.png"}
                            alt="framed"
                        />
                    </span>
                </li>
            ...
            <ul className="gx-nav-option gx-list-inline">
                <li>
                    <span
                        ...
                        className={`gx-pointer ${
                            navStyle === NAV_STYLE_FIXED && "active"
                        }`}
                    >
                        <img
                            src={"/assets/images/layouts/fixed.png"}
                            alt="fixed"
                        />
                    </span>
                </li>
                <li>
                    <span
                        onClick={() =>
                            onNavStyleChanges(NAV_STYLE_MINI_SIDEBAR)
                        }
                        className={`gx-pointer ${
                ...
                <li>
                    <span
                        onClick={() =>
                            onNavStyleChanges(NAV_STYLE_NO_HEADER_MINI_SIDEBAR)
                        }
                        className={`gx-pointer ${
                    ...
                    >
                        <img
                            src={
                                "/assets/images/layouts/no header mini sidebar.png"
                            }
                ...
                <li>
                    ...
                    >
                        <img
                            src={
                                "/assets/images/layouts/vertical no header.png"
                            }
                ...
                <li>
                    <span
                        onClick={() =>
                            onNavStyleChanges(NAV_STYLE_DEFAULT_HORIZONTAL)
                        }
                        className={`gx-pointer ${
                    ...
                    >
                        <img
                            src={
                                "/assets/images/layouts/default horizontal.png"
                            }
                ...
                <li>
                    <span
                        onClick={() =>
                            onNavStyleChanges(NAV_STYLE_DARK_HORIZONTAL)
                        }
                        className={`gx-pointer ${
                ...
                <li>
                    ...
                    >
                        <img
                            src={
                                "/assets/images/layouts/inside header horizontal.png"
                            }
                ...
                <li>
                    <span
                        onClick={() =>
                            onNavStyleChanges(NAV_STYLE_BELOW_HEADER)
                        }
                        className={`gx-pointer ${
                ...
                <li>
                    <span
                        onClick={() =>
                            onNavStyleChanges(NAV_STYLE_ABOVE_HEADER)
                        }
                        className={`gx-pointer ${

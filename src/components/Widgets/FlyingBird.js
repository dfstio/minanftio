        ...
        <Widget>
            <div className="gx-media gx-align-items-center gx-mb-4">
                ...
                <div className="gx-media-body">
                    <h2 className="gx-mb-1">Flying bird</h2>
                    <p className="gx-text-grey gx-mb-0">Bob Bush</p>
                </div>
            </div>
            <p className="gx-mb-4">
                Some description about the card. This widget could be used to
                describe a project, a product, user’s profile or may be more.
            </p>

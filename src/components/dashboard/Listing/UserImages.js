    ...
    return (
        <Aux>
                    ...
                    <li key={index}>
                        <div className="gx-profileon gx-pointer">
                            ...
                            <div className="gx-profileon-content">
                                <h5 className="gx-mb-1 gx-text-truncate">
                                    {user.name}
                                </h5>
                                <p className="gx-mb-0 gx-fs-sm gx-text-truncate">
                                    ...
                                    />{" "}
                                    {user.rating}{" "}
                                    <span className="gx-px-sm-1">|</span>{" "}
                                    {user.deals}
                                </p>
                            </div>
                        </div>
            ...
            <span className="gx-text-primary gx-fs-md gx-pointer gx-mb-4 gx-d-block gx-d-sm-none">
                Go to agents list{" "}
                <i className="icon icon-long-arrow-right gx-fs-xxl gx-ml-2 gx-ml-2 gx-d-inline-flex gx-vertical-align-middle" />
            </span>
        </Aux>
    );
};

...
const PropertiesItemCard = ({ data }) => {
    ...
    return (
        <div className="gx-media gx-featured-item">
            {isFeatured === true ? (
                <Tag color="orange">
                    <span className="gx-text-uppercase">featured</span>
                </Tag>
            ) : null}
            <div className="gx-featured-thumb">
                <img
                    ...
                    alt="..."
                />
                <Tag className="gx-rounded-xs gx-bg-orange gx-border-orange gx-text-white">
                    Featured
                </Tag>
            </div>
            <div className="gx-media-body gx-featured-content">
                <div className="gx-featured-content-left">
                    ...
                    <div className="ant-row-flex">
                        ...
                        <p className="gx-mr-3 gx-mb-1">
                            <span className="gx-text-grey">Baths:</span> {baths}
                        </p>
                        <p className="gx-mr-3 gx-mb-1">

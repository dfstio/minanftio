  ...
  return (
    <div>
      ...
      <div className="gx-d-flex justify-content-center">
        <h4>
          There will be the helper tools to help MinaNFT offline CLI tool to get
          infromation from MINA blockchain and to write transactions to
          blockchain prepared and signed offline
        </h4>
      </div>
    </div>
  );
